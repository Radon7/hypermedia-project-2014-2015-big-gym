...
--
-- Host: localhost
-- Generation Time: Giu 13, 2015 alle 19:55
...
('allcourses', '<p>Here you can find the list of all the courses we offer. Do you like action? Try our Spartan Training course! Do you feel old or novice? Do not worry! We are proud to say that you will find courses for all ranges of age and difficulties. You will definitely find one that suits you! We''re waiting for you!</p>'),

...
function getInstructorInfo(variable) {
    $.ajax({
        ...
        success: function (response) {
            ...
            //carico la gallery
            $("#gallery").html('<div class="item active"><img  class="img-responsive center-block" src="'+'./img/instructors/'+instr[0].image_1+'" alt="..."></div><div class="item"><img class="img-responsive center-block" src="./img/instructors/'+instr[0].image_1+'" alt="Chania"></div><div class="item"><img  class="img-responsive center-block" src="./img/instructors/'+instr[0].image_1+'" alt="Flower"></div>' );
